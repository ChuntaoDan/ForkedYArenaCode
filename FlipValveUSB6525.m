...
% skip this reading step simply because it takes too long (2.5s)
% set(valvedio.Channels,'Direction','input')
% stateNow=inputSingleScan(valvedio) ;
...
if iscell(lines)
    ...
    for i=1:length(lines)
        ...
        if ~isempty(thisLine)
            ...
            error('Some of the vial names can not be found\n');
        end
    end
    
end

% set(valvedio.Channels,'Direction','output')
