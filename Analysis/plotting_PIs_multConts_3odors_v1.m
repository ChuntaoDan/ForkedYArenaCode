...
%                 hold off
                ...
                if conts > 1
                    ...
                    [summed_choices_ends,summed_O_choices_ends, summed_P_O_choices_ends,summed_M_choices_ends, summed_P_M_choices_ends,fig_count,net_summed_choices,gotofig,gotogifg3] = summed_choices_mult_conts_3odor(cps,x_y_time_color,fig_count,protocol_100_0,reward,conts,gotofig,gotofig3,pre_sumM,pre_sumO,pre_sumPO,pre_sumPM);

                else
                    [summed_choices_ends,summed_O_choices_ends, summed_P_O_choices_ends,summed_M_choices_ends, summed_P_M_choices_ends,fig_count,net_summed_choices,gotofig,gotofig3] = summed_choices_mult_conts_3odor(cps,x_y_time_color,fig_count,protocol_100_0,reward,conts,gotofig,gotofig3,0,0,0,0);
