...
%             end    
        ...
        if reward_order(i) == 0 && reward_order(i-1) == 0 && reward_order(i-2) == 0 && choice_order(i) == 2 && choice_order(i-1) == 1 && choice_order(i-2) == 1 
        count_1 = count_1+1;
        ...
        for i = 3:length(choice_order)-1
        if reward_order(i) == 0 && reward_order(i-1) == 0 && reward_order(i-2) == 1 && choice_order(i) == 2 && choice_order(i-1) == 1 && choice_order(i-2) == 1 
            count_2 = count_2+1;
        ...
        for i = 3:length(choice_order)-1
        if reward_order(i) == 0 && reward_order(i-1) == 1 && reward_order(i-2) == 1 && choice_order(i) == 2 && choice_order(i-1) == 1 && choice_order(i-2) == 1 
            count_3 = count_3+1;
        ...
        for i = 3:length(choice_order)-1
        if reward_order(i) == 0 && reward_order(i-1) == 0 && reward_order(i-2) == 0 && choice_order(i) == 1 && choice_order(i-1) == 2 && choice_order(i-2) == 2 
            count_4 = count_4+1;
        ...
        for i = 3:length(choice_order)-1
        if reward_order(i) == 0 && reward_order(i-1) == 0 && reward_order(i-2) == 1  && choice_order(i) == 1 && choice_order(i-1) == 2 && choice_order(i-2) == 2
           count_5 = count_5+1;
        ...
        for i = 3:length(choice_order)-1
        if reward_order(i) == 0 && reward_order(i-1) == 1 && reward_order(i-2) == 1  && choice_order(i) == 1 && choice_order(i-1) == 2 && choice_order(i-2) == 2 
           count_6 = count_6+1;
