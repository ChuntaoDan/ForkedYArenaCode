...
dataPath = [tempPath1, '\', handles.expStartTime, '_',handles.rig, '_',...
    'Cam', num2str(1-1),'_OCTp_switchingArms_4'];
...
pause(118) % duration of odor presentation is 60 seconds but a pause of 2 seconds is previously already used to allow for appropriate LED delay. 60 -2  = 58
